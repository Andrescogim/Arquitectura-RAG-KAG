...
def guardar_resultados(resultados, nombre_archivo, ruta):
    ...
    # out_name = f"/graph_answer_2Wiki_{fecha_hora}.json"
    out_name = f"/{nombre_archivo}_{fecha_hora}.json"
    out_file = f"{ruta}{out_name}"
...
def guardar_registro(ruta, comentarios, n_registros, metricas_totales, modelo_LLM, prompt, opciones_LLM):
    """
    ...
    with open(out_file, "w", encoding="utf-8") as f:
        ...
        f.write(f"Nº filas procesadas: {n_registros}\n\n")
